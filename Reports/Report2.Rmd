---
title: "Report2 - Three patch model with vaccination"
...
alpha <-
  matrix(
    c(0.95, 0.02, 0.03, 0.02, 0.96, 0.02, 0.03, 0.02, 0.95),
    nrow = 3,
    ncol = 3,
    byrow = TRUE
  )
...
$$\mathbf{NGM } = \left[\begin{array}
{rrr}
\frac{\beta_L \alpha_{LL} (1-C_L)}{\gamma_L} & \frac{\beta_L \alpha_{LM} (1-C_L)}{\gamma_M} & \frac{\beta_L \alpha_{LH}(1-C_L)}{\gamma_H} \\
\frac{\beta_M \alpha_{ML}(1-C_M)}{\gamma_L} &  \frac{\beta_M\alpha_{MM}(1-C_M)}{\gamma_M} & \frac{\beta_M \alpha_{MH}(1-C_M)}{\gamma_H} \\
\frac{\beta_H \alpha_{HL}(1-C_H)}{\gamma_L} & \frac{\beta_H \alpha_{HM}(1-C_H)}{\gamma_M} & \frac{\beta_H \alpha_{HH} (1-C_H)}{\gamma_H}
\end{array}\right]
$$
